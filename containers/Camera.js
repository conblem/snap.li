...
class CameraContainer extends Component {
    ...
    render() {
        ...
        return (<View style={styles.container}>
            {photo === null
                ? <Camera ref={ref => this.camera = ref} style={styles.camera} type={position} />
                : <Image source={{ uri: photo }} style={styles.photo} />
            }
            <CameraMenu snap={photo === null ? this.snap : this.send} close={() => this.setState({ photo: null })} switchCamera={this.switchCamera} />
        </View>)
    }
}
